...
// # Save the file
// with open('/mnt/agents/output/Odontogram.tsx', 'w', encoding='utf-8') as f:
//     f.write(odontogram_code)

// print("✅ Odontogram.tsx created successfully!")
// print(f"📁 File saved to: /mnt/agents/output/Odontogram.tsx")
// print(f"📊 File size: {len(odontogram_code)} characters")
